    ...
    <form onSubmit={handleSubmit(submitProfileForm)}>
        ...
        <div className="flex flex-col gap-5 lg:flex-row">
          <div className="flex flex-col gap-2 lg:w-[48%]">
            ...
            <input
              ...
              className="w-full rounded-lg bg-richblack-700 text-richblack-5 placeholder:text-richblack-400 border border-richblack-600 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-50 transition-all duration-200"
        ...
        <div className="flex flex-col gap-5 lg:flex-row">
          <div className="flex flex-col gap-2 lg:w-[48%]">
            ...
            <input
              ...
              name="dateOfBirth"
              id="dateOfBirth"
              className="w-full rounded-lg bg-richblack-700 text-richblack-5 border border-richblack-600 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-50 transition-all duration-200"
      ...
      <div className="flex justify-end gap-2">
        <button
          ...
          className="cursor-pointer rounded-md bg-richblack-700 py-2 px-5 font-semibold text-richblack-50 hover:bg-richblack-600 transition"
        >
          Cancel
        </button>
